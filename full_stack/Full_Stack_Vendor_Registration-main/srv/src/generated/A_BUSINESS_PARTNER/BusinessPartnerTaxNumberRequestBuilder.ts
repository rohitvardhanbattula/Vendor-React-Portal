 ...
 */
export class BusinessPartnerTaxNumberRequestBuilder<
...
> extends RequestBuilder<BusinessPartnerTaxNumber<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<BusinessPartnerTaxNumber<T>, T> {
    return new GetAllRequestBuilder<BusinessPartnerTaxNumber<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessPartnerTaxNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessPartnerTaxNumber<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessPartnerTaxNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BusinessPartnerTaxNumber<T>, T>(
      this.entityApi,
      businessPartnerOrEntity instanceof BusinessPartnerTaxNumber
