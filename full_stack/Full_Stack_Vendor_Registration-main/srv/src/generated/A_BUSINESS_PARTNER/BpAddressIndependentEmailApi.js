...
exports.BpAddressIndependentEmailApi = void 0;
/*
...
const BpAddressIndependentEmailRequestBuilder_1 = require("./BpAddressIndependentEmailRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class BpAddressIndependentEmailApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = BpAddressIndependentEmail_1.BpAddressIndependentEmail;
    ...
    requestBuilder() {
        return new BpAddressIndependentEmailRequestBuilder_1.BpAddressIndependentEmailRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(BpAddressIndependentEmail_1.BpAddressIndependentEmail, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', BpAddressIndependentEmail_1.BpAddressIndependentEmail)
            };
        }
        return this._schema;
    }
}
exports.BpAddressIndependentEmailApi = BpAddressIndependentEmailApi;
//# sourceMappingURL=BpAddressIndependentEmailApi.js.map