...
> implements EntityApi<CustomerSalesArea<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    ...
    CUSTOMER_PRICING_PROCEDURE: OrderableEdmTypeField<
      ...
      true
    >;
    CUSTOMER_STATISTICS_GROUP: OrderableEdmTypeField<
      CustomerSalesArea<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link customerStatisticsGroup} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        CUSTOMER_STATISTICS_GROUP: fieldBuilder.buildEdmTypeField(
