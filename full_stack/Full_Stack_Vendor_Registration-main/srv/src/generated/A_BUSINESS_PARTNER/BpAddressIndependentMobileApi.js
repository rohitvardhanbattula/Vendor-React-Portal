...
exports.BpAddressIndependentMobileApi = void 0;
/*
...
const BpAddressIndependentMobileRequestBuilder_1 = require("./BpAddressIndependentMobileRequestBuilder");
const odata_v2_1 = require("@sap-cloud-sdk/odata-v2");
class BpAddressIndependentMobileApi {
    constructor(deSerializers = odata_v2_1.defaultDeSerializers) {
        this.entityConstructor = BpAddressIndependentMobile_1.BpAddressIndependentMobile;
    ...
    requestBuilder() {
        return new BpAddressIndependentMobileRequestBuilder_1.BpAddressIndependentMobileRequestBuilder(this);
    }
    entityBuilder() {
    ...
    get fieldBuilder() {
        if (!this._fieldBuilder) {
            this._fieldBuilder = new odata_v2_1.FieldBuilder(BpAddressIndependentMobile_1.BpAddressIndependentMobile, this.deSerializers);
        }
    ...
    get schema() {
        if (!this._schema) {
            ...
            this._schema = {
                 ...
                 * Use to reference this property in query operations such as 'select' in the fluent request API.
                 */
                MOBILE_PHONE_NUMBER: fieldBuilder.buildEdmTypeField('MobilePhoneNumber', 'Edm.String', true),
                /**
                 ...
                 * All fields selector.
                 */
                ALL_FIELDS: new odata_v2_1.AllFields('*', BpAddressIndependentMobile_1.BpAddressIndependentMobile)
            };
        }
        return this._schema;
    }
}
exports.BpAddressIndependentMobileApi = BpAddressIndependentMobileApi;
//# sourceMappingURL=BpAddressIndependentMobileApi.js.map