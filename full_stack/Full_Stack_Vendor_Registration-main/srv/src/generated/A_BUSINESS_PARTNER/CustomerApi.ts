...
> implements EntityApi<Customer<DeSerializersT>, DeSerializersT>
{
  ...
  private _schema?: {
    ...
    COUNTY: OrderableEdmTypeField<
      ...
      true
    >;
    BR_ICMS_TAX_PAYER_TYPE: OrderableEdmTypeField<
      Customer<DeSerializers>,
      DeSerializersT,
      'Edm.String',
      true,
  ...
  get schema() {
    if (!this._schema) {
      ...
      this._schema = {
        ...
        /**
         * Static representation of the {@link brIcmsTaxPayerType} property for query construction.
         * Use to reference this property in query operations such as 'select' in the fluent request API.
         */
        BR_ICMS_TAX_PAYER_TYPE: fieldBuilder.buildEdmTypeField(
          'BR_ICMSTaxPayerType',
          'Edm.String',
          true
        ),
