 ...
 */
export class SupplierWithHoldingTaxRequestBuilder<
...
> extends RequestBuilder<SupplierWithHoldingTax<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<SupplierWithHoldingTax<T>, T> {
    return new GetAllRequestBuilder<SupplierWithHoldingTax<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<SupplierWithHoldingTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SupplierWithHoldingTax<T>, T>(
      this.entityApi,
      {
        Supplier: supplier,
  ...
  update(
    ...
    return new UpdateRequestBuilder<SupplierWithHoldingTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SupplierWithHoldingTax<T>, T>(
      this.entityApi,
      supplierOrEntity instanceof SupplierWithHoldingTax
        ? supplierOrEntity
        : {
