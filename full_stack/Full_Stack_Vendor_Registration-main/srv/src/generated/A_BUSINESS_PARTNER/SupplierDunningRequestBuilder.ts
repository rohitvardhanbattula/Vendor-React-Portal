 ...
 */
export class SupplierDunningRequestBuilder<
...
> extends RequestBuilder<SupplierDunning<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<SupplierDunning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<SupplierDunning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SupplierDunning<T>, T>(
      this.entityApi,
      supplierOrEntity instanceof SupplierDunning
        ? supplierOrEntity
        : {
