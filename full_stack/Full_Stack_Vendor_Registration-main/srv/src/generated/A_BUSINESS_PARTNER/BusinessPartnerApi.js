...
class BusinessPartnerApi {
    ...
    _addNavigationProperties(linkedApis) {
        this.navigationPropertyFields = {
            TO_ADDRESS_INDEPENDENT_EMAIL: new odata_v2_1.Link('to_AddressIndependentEmail', this, linkedApis[0]),
            TO_ADDRESS_INDEPENDENT_FAX: new odata_v2_1.Link('to_AddressIndependentFax', this, linkedApis[1]),
            TO_ADDRESS_INDEPENDENT_MOBILE: new odata_v2_1.Link('to_AddressIndependentMobile', this, linkedApis[2]),
            TO_ADDRESS_INDEPENDENT_PHONE: new odata_v2_1.Link('to_AddressIndependentPhone', this, linkedApis[3]),
            TO_ADDRESS_INDEPENDENT_WEBSITE: new odata_v2_1.Link('to_AddressIndependentWebsite', this, linkedApis[4]),
            TO_BP_CREDIT_WORTHINESS: new odata_v2_1.OneToOneLink('to_BPCreditWorthiness', this, linkedApis[5]),
            TO_BP_DATA_CONTROLLER: new odata_v2_1.Link('to_BPDataController', this, linkedApis[6]),
            TO_BP_EMPLOYMENT: new odata_v2_1.Link('to_BPEmployment', this, linkedApis[7]),
            TO_BP_FIN_SERVICES_REPORTING: new odata_v2_1.OneToOneLink('to_BPFinServicesReporting', this, linkedApis[8]),
            TO_BP_FISCAL_YEAR_INFORMATION: new odata_v2_1.Link('to_BPFiscalYearInformation', this, linkedApis[9]),
            TO_BP_RELATIONSHIP: new odata_v2_1.Link('to_BPRelationship', this, linkedApis[10]),
            TO_BU_PA_IDENTIFICATION: new odata_v2_1.Link('to_BuPaIdentification', this, linkedApis[11]),
            TO_BU_PA_INDUSTRY: new odata_v2_1.Link('to_BuPaIndustry', this, linkedApis[12]),
            TO_BUSINESS_PARTNER: new odata_v2_1.OneToOneLink('to_BusinessPartner', this, linkedApis[13]),
            TO_BUSINESS_PARTNER_ADDRESS: new odata_v2_1.Link('to_BusinessPartnerAddress', this, linkedApis[14]),
            TO_BUSINESS_PARTNER_ALIAS: new odata_v2_1.Link('to_BusinessPartnerAlias', this, linkedApis[15]),
            TO_BUSINESS_PARTNER_BANK: new odata_v2_1.Link('to_BusinessPartnerBank', this, linkedApis[16]),
            TO_BUSINESS_PARTNER_CONTACT: new odata_v2_1.Link('to_BusinessPartnerContact', this, linkedApis[17]),
            TO_BUSINESS_PARTNER_IS_BANK: new odata_v2_1.OneToOneLink('to_BusinessPartnerIsBank', this, linkedApis[18]),
            TO_BUSINESS_PARTNER_RATING: new odata_v2_1.Link('to_BusinessPartnerRating', this, linkedApis[19]),
            TO_BUSINESS_PARTNER_ROLE: new odata_v2_1.Link('to_BusinessPartnerRole', this, linkedApis[20]),
            TO_BUSINESS_PARTNER_TAX: new odata_v2_1.Link('to_BusinessPartnerTax', this, linkedApis[21]),
            TO_BUS_PART_ADDR_DEPDNT_TAX_NMBR: new odata_v2_1.Link('to_BusPartAddrDepdntTaxNmbr', this, linkedApis[22]),
            TO_CUSTOMER: new odata_v2_1.OneToOneLink('to_Customer', this, linkedApis[23]),
            TO_PAYMENT_CARD: new odata_v2_1.Link('to_PaymentCard', this, linkedApis[24]),
            TO_SUPPLIER: new odata_v2_1.OneToOneLink('to_Supplier', this, linkedApis[25])
        };
        return this;
    }
    requestBuilder() {
