 ...
 */
export class CustSalesPartnerFuncRequestBuilder<
...
> extends RequestBuilder<CustSalesPartnerFunc<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<CustSalesPartnerFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<CustSalesPartnerFunc<T>, T>(
      this.entityApi,
      {
        Customer: customer,
  ...
  update(
    ...
    return new UpdateRequestBuilder<CustSalesPartnerFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<CustSalesPartnerFunc<T>, T>(
      this.entityApi,
      customerOrEntity instanceof CustSalesPartnerFunc
        ? customerOrEntity
        : {
