 ...
 */
export class AddressFaxNumberRequestBuilder<
...
> extends RequestBuilder<AddressFaxNumber<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<AddressFaxNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<AddressFaxNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<AddressFaxNumber<T>, T>(
      this.entityApi,
      addressIdOrEntity instanceof AddressFaxNumber
        ? addressIdOrEntity
        : {
