 ...
 */
export class AddressEmailAddressRequestBuilder<
...
> extends RequestBuilder<AddressEmailAddress<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<AddressEmailAddress<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AddressEmailAddress<T>, T>(
      this.entityApi,
      {
        AddressID: addressId,
        Person: person,
  ...
  update(
    ...
    return new UpdateRequestBuilder<AddressEmailAddress<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<AddressEmailAddress<T>, T>(
      this.entityApi,
      addressIdOrEntity instanceof AddressEmailAddress
        ? addressIdOrEntity
        : {
