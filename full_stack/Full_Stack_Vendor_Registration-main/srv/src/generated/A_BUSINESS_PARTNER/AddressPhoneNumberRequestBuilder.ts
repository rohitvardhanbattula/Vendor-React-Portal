 ...
 */
export class AddressPhoneNumberRequestBuilder<
...
> extends RequestBuilder<AddressPhoneNumber<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<AddressPhoneNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<AddressPhoneNumber<T>, T>(
      this.entityApi,
      {
        AddressID: addressId,
        Person: person,
  ...
  update(
    ...
    return new UpdateRequestBuilder<AddressPhoneNumber<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<AddressPhoneNumber<T>, T>(
      this.entityApi,
      addressIdOrEntity instanceof AddressPhoneNumber
        ? addressIdOrEntity
        : {
