 ...
 */
export class BusinessPartnerBankRequestBuilder<
...
> extends RequestBuilder<BusinessPartnerBank<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessPartnerBank<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessPartnerBank<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessPartnerBank<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BusinessPartnerBank<T>, T>(
      this.entityApi,
      businessPartnerOrEntity instanceof BusinessPartnerBank
