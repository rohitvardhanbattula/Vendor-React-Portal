  ...
  implements BusinessPartnerType<T>
{
   ...
   */
  toBusinessPartnerAlias: BusinessPartnerAlias<T>[];
  /**
   ...
   */
  toBusinessPartnerIsBank?: BusinessPartnerIsBank<T> | null;
  /**
