 ...
 */
export class SupplierPartnerFuncRequestBuilder<
...
> extends RequestBuilder<SupplierPartnerFunc<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<SupplierPartnerFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SupplierPartnerFunc<T>, T>(
      this.entityApi,
      {
        Supplier: supplier,
  ...
  update(
    ...
    return new UpdateRequestBuilder<SupplierPartnerFunc<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SupplierPartnerFunc<T>, T>(
      this.entityApi,
      supplierOrEntity instanceof SupplierPartnerFunc
        ? supplierOrEntity
        : {
