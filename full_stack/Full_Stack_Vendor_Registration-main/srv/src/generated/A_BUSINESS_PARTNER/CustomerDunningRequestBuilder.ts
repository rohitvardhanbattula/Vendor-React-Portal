 ...
 */
export class CustomerDunningRequestBuilder<
...
> extends RequestBuilder<CustomerDunning<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<CustomerDunning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<CustomerDunning<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<CustomerDunning<T>, T>(
      this.entityApi,
      customerOrEntity instanceof CustomerDunning
        ? customerOrEntity
        : {
