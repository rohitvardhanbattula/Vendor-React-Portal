 ...
 */
export class BuPaIdentificationRequestBuilder<
...
> extends RequestBuilder<BuPaIdentification<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<BuPaIdentification<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BuPaIdentification<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<BuPaIdentification<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BuPaIdentification<T>, T>(
      this.entityApi,
      businessPartnerOrEntity instanceof BuPaIdentification
