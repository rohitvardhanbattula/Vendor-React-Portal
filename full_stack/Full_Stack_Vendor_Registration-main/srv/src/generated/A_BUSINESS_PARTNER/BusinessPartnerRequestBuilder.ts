 ...
 */
export class BusinessPartnerRequestBuilder<
...
> extends RequestBuilder<BusinessPartner<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessPartner<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessPartner<T>, T>(this.entityApi, {
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessPartner<T>, T>(
      this.entityApi,
      entity
    );
  }
