 ...
 */
export class CustomerSalesAreaTextRequestBuilder<
...
> extends RequestBuilder<CustomerSalesAreaText<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<CustomerSalesAreaText<T>, T> {
    return new GetAllRequestBuilder<CustomerSalesAreaText<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<CustomerSalesAreaText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<CustomerSalesAreaText<T>, T>(
      this.entityApi,
      {
        Customer: customer,
  ...
  update(
    ...
    return new UpdateRequestBuilder<CustomerSalesAreaText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<CustomerSalesAreaText<T>, T>(
      this.entityApi,
      customerOrEntity instanceof CustomerSalesAreaText
        ? customerOrEntity
        : {
