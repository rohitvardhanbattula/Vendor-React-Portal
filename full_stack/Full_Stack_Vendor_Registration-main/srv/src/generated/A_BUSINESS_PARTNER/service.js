...
exports.aBusinessPartner = aBusinessPartner;
/*
...
function aBusinessPartner(deSerializers = odata_v2_1.defaultDeSerializers) {
    return new ABusinessPartner((0, odata_v2_1.mergeDefaultDeSerializersWith)(deSerializers));
}
class ABusinessPartner {
