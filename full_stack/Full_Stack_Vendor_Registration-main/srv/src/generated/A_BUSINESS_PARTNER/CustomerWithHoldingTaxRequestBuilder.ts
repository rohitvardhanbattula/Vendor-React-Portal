 ...
 */
export class CustomerWithHoldingTaxRequestBuilder<
...
> extends RequestBuilder<CustomerWithHoldingTax<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<CustomerWithHoldingTax<T>, T> {
    return new GetAllRequestBuilder<CustomerWithHoldingTax<T>, T>(
      this.entityApi
    );
  }
  ...
  create(
    ...
    return new CreateRequestBuilder<CustomerWithHoldingTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<CustomerWithHoldingTax<T>, T>(
      this.entityApi,
      {
        Customer: customer,
  ...
  update(
    ...
    return new UpdateRequestBuilder<CustomerWithHoldingTax<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<CustomerWithHoldingTax<T>, T>(
      this.entityApi,
      customerOrEntity instanceof CustomerWithHoldingTax
        ? customerOrEntity
        : {
