 ...
 */
export class BusinessPartnerRoleRequestBuilder<
...
> extends RequestBuilder<BusinessPartnerRole<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<BusinessPartnerRole<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<BusinessPartnerRole<T>, T>(
      this.entityApi,
      {
  ...
  update(
    ...
    return new UpdateRequestBuilder<BusinessPartnerRole<T>, T>(
      this.entityApi,
      entity
    );
  }
