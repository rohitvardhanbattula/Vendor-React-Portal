 ...
 */
export class BuPaIndustryRequestBuilder<
...
> extends RequestBuilder<BuPaIndustry<T>, T> {
  ...
  delete(
    industrySectorOrEntity: any,
    industrySystemType?: string,
    businessPartner?: string
  ): DeleteRequestBuilder<BuPaIndustry<T>, T> {
    return new DeleteRequestBuilder<BuPaIndustry<T>, T>(
      this.entityApi,
      industrySectorOrEntity instanceof BuPaIndustry
