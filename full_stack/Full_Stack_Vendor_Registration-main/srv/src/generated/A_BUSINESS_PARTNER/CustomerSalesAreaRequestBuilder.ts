 ...
 */
export class CustomerSalesAreaRequestBuilder<
...
> extends RequestBuilder<CustomerSalesArea<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<CustomerSalesArea<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<CustomerSalesArea<T>, T>(
      this.entityApi,
      entity
    );
  }
