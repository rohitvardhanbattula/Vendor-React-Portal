...
/**
 * Batch builder for operations supported on the A Business Partner.
 * @param requests The requests of the batch.
 * @returns A request builder for batch.
 */
export function batch<DeSerializersT extends DeSerializers>(
  ...requests: Array<
    | ReadABusinessPartnerRequestBuilder<DeSerializersT>
...
export function batch<DeSerializersT extends DeSerializers>(
  ...
  return new ODataBatchRequestBuilder(
    defaultABusinessPartnerPath,
    transformVariadicArgumentToArray(first, rest)
  );
}

/**
 * Change set constructor consists of write operations supported on the A Business Partner.
 * @param requests The requests of the change set.
 * @returns A change set for batch.
 */
export function changeset<DeSerializersT extends DeSerializers>(
  ...requests: Array<WriteABusinessPartnerRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  requests: Array<WriteABusinessPartnerRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT>;
export function changeset<DeSerializersT extends DeSerializers>(
  first:
    | undefined
    | WriteABusinessPartnerRequestBuilder<DeSerializersT>
    | Array<WriteABusinessPartnerRequestBuilder<DeSerializersT>>,
  ...rest: Array<WriteABusinessPartnerRequestBuilder<DeSerializersT>>
): BatchChangeSet<DeSerializersT> {
  return new BatchChangeSet(transformVariadicArgumentToArray(first, rest));
}

export const defaultABusinessPartnerPath =
  '/sap/opu/odata/sap/API_BUSINESS_PARTNER';
export type ReadABusinessPartnerRequestBuilder<
...
> =
  ...
  | GetByKeyRequestBuilder<
      ...
      DeSerializersT
    >;
export type WriteABusinessPartnerRequestBuilder<
  DeSerializersT extends DeSerializers
> =
