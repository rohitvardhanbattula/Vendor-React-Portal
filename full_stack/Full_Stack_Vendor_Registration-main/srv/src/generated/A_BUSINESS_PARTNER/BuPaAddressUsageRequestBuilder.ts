 ...
 */
export class BuPaAddressUsageRequestBuilder<
...
> extends RequestBuilder<BuPaAddressUsage<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<BuPaAddressUsage<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  update(
    ...
    return new UpdateRequestBuilder<BuPaAddressUsage<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<BuPaAddressUsage<T>, T>(
      this.entityApi,
      businessPartnerOrEntity instanceof BuPaAddressUsage
