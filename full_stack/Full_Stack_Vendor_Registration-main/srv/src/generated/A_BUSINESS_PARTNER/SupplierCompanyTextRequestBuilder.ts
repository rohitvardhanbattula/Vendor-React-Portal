 ...
 */
export class SupplierCompanyTextRequestBuilder<
...
> extends RequestBuilder<SupplierCompanyText<T>, T> {
  ...
  create(
    ...
    return new CreateRequestBuilder<SupplierCompanyText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<SupplierCompanyText<T>, T>(
      this.entityApi,
      {
        Supplier: supplier,
  ...
  update(
    ...
    return new UpdateRequestBuilder<SupplierCompanyText<T>, T>(
      this.entityApi,
      entity
    );
  }
  ...
  delete(
    ...
    return new DeleteRequestBuilder<SupplierCompanyText<T>, T>(
      this.entityApi,
      supplierOrEntity instanceof SupplierCompanyText
        ? supplierOrEntity
        : {
